...
const getOrderMessageHTML = (orderId, messageFromTo, messageText) => {
  ...
  if (messageFromTo === MessageFromToOptions.ManufacturerToUser) {
    ...
    <p style="color: #979797; margin-bottom: 24px">Для ответа на сообщение или просмотра заказа, перейдите по ссылке ${siteHost}/order-item/${orderId}</p>
  ...
  `;
    ...
    <p style="color: #4A4A4A; margin-bottom: 24px; white-space: pre-line">${messageText}</p>
    <p style="color: #979797; margin-bottom: 24px">Для ответа на сообщение или просмотра заказа, перейдите по ссылке ${siteHost}/manufacturer-order-item/${orderId}</p>
    <p style="color: #FF8E00; margin-bottom: 48px">Данное письмо сформировано автоматически и отвечать на него не нужно</p>
  `;
    ...
    <p style="color: #4A4A4A; margin-bottom: 24px; white-space: pre-line">${messageText}</p>
    <p style="color: #979797; margin-bottom: 24px">Для просмотра заказа, перейдите по ссылке ${siteHost}/manufacturer-order-item/${orderId}</p>
    <p style="color: #FF8E00; margin-bottom: 48px">Данное письмо сформировано автоматически и отвечать на него не нужно</p>
  `;
    ...
    <p style="color: #4A90E2; margin-bottom: 24px">Автоматическое сообщение по заказу № ${orderId} на ${siteName}</p>
    <p style="color: #4A4A4A; margin-bottom: 24px; white-space: pre-line">${messageText}</p>
    <p style="color: #979797; margin-bottom: 24px">Для просмотра заказа, перейдите по ссылке ${siteHost}/order-item/${orderId}</p>
    <p style="color: #FF8E00; margin-bottom: 48px">Данное письмо сформировано автоматически и отвечать на него не нужно</p>
  `;
  }
};
