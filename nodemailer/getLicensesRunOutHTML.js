const getLicensesRunOutHTML = (manufacturerTitle) => {
  ...
  return `
    ...
    <p style="color: #FF0000;">На вашем акаунте закончился пакет лицензий для публикаций.</p>
    <p style="color: #4A4A4A; margin-bottom: 24px; line-height: 12px; white-space: pre-line">
      Следующей ночью ваши товары будут сняты с публикации и станут недоступны для заказа покупателям.<br />
      Если вы хотите продолжить публикацию и продажи своих товаров через наш сайт, то приобретите лицензии и продолжите публикацию товаров.
    </p>
