  ...
  return `
    ...
    <body style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
      ...
      <p style="color: #4A90E2; margin-bottom: 12px">
          В момент активации мы вам начислим 500 приветственных лицензий на публикацию ваших товаров,
          <br>что бы вы смогли расширить географию продаж и опубликовать свои первые обьявления.
          <br>
